...
# Webcomponent - Tourist Attractions Bolzano
...
This project consist of a responsive web component which displays information on Cultural Attractions, Skiing Locations and more.
As of `v0.1.0.1`, the data feeding the component is defined locally via a JSON file, as we couldn't find NOI API to provide the necessary information.

- [Tourist Attractions Bolzano](#tourist-attractions-bolzano)
  - [Usage](#usage)
...
Include the webcompscript file `dist/webcomp-boilerplate.min.js` in your HTML and define the web component like this:

```html
<attractions-bolzano></attractions-bolzano>
```

### Attributes

As of right now, no attributes can be defined to modify the component's behaviour.
...
```bash
git clone https://github.com/noi-techpark/webcomp-attractionsBolzano.git
```

Change directory:

```bash
cd webcomp-attractionsBolzano/
```
